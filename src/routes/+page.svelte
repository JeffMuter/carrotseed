...
<style>
  body {
    background-image: url("green_farm_field.jpg"); /* Path to your background image */
    background-size: cover; /* Covers the entire window */
  ...
  .glassy-div {
    ...
    padding: 3rem; /* Space inside the div */
